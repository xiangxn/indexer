...
class Logger(object):
    ...
    def __init__(self, name="center", debug=False, screen=True, email: dict = None):
        self.is_debug = debug
        ...
        if email:
            self.email_handle = logging.handlers.SMTPHandler((email['host'], email['port']), email['from'], email['to'], f"{name}_logs",
